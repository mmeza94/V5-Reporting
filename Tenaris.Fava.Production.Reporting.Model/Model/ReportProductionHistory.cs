...
{
    [NHMA.Class(Table = "ReportProductionHistory", Schema = "Production")]
    public class ReportProductionHistory
    {

        [NHMA.Id(0, Name = "Id", TypeType = typeof(Int32), Column = "idReportProductionHistory", Access = "property")]
        [NHMA.Generator(1, Class = "native")]
        public virtual int Id { get; set; }

        [NHMA.Property(Name = "IdHistory", Access = "property", Column = "idHistory", NotNull = true)]
        ...
        //[NHMA.Property(Name = "WarnedCount", Access = "property", Column = "WarnedCount", NotNull = true)]
        //public virtual int WarnedCount { get; set; }

        [NHMA.Property(Name = "ScrapCount", Access = "property", Column = "ScrapCount", NotNull = true)]
        public virtual int ScrapCount { get; set; }

        // [NHMA.Property(Name = "StandardCount", Access = "property", Column = "StandardCount", NotNull = true)]
        //public virtual int StandardCount { get; set; }

        //[NHMA.Property(Name = "TransferenceCount", Access = "property", Column = "TransferenceCount", NotNull = true)]
        //public virtual int TransferenceCount { get; set; }


        #region comentado para pruebas
        //[NHMA.Property(Name = "PendingCount", Access = "property", Column = "PendingCount", NotNull = true)]
        ...
        //public virtual DateTimeOffset InsDateTime { get; set; }
        ...
        [NHMA.Property(Name = "GroupItemType", Access = "property", Column = "GroupItemType", NotNull = false)]
        public virtual string GroupItemType { get; set; }

        [NHMA.Property(Name = "ChildOrder", Access = "property", Column = "ChildOrderNumber", NotNull = false)]
        public virtual int? ChildOrder { get; set; }

        [NHMA.Property(Name = "ChildGroupItemNumber", Access = "property", Column = "ChildGroupItemNumber", NotNull = false)]
        public virtual int? ChildGroupItemNumber { get; set; }

        [NHMA.Property(Name = "ChildGroupItemType", Access = "property", Column = "ChildGroupItemType", NotNull = false)]
        public virtual string ChildGroupItemType { get; set; }
    }
}
